...
test("provides semantic structure for the static application shell", () => {
  ...
  assert.match(indexHtml, /js\/main\.js\?v=20260811-ios-map-export/);
...
test("uses modal confirmation for destructive actions and keeps map export labels visible", () => {
  ...
  assert.match(mapExportSource, /const svgUrl = "data:image\/svg\+xml;base64," \+ btoa/);
  ...
  assert.match(mainSource, /api\.js\?v=20260811-ios-map-export/);
  assert.match(mainSource, /ui\.js\?v=20260811-ios-map-export/);
  assert.match(mainSource, /events\.js\?v=20260811-ios-map-export/);
  assert.match(eventsSource, /api\.js\?v=20260811-ios-map-export/);
  assert.match(eventsSource, /ui\.js\?v=20260811-ios-map-export/);
  assert.match(worldSelectorSource, /api\.js\?v=20260811-ios-map-export/);
  assert.match(guildNameEditorSource, /ui\.js\?v=20260811-ios-map-export/);
  assert.match(occupationTabsSource, /ui\.js\?v=20260811-ios-map-export/);
  assert.match(occupationTabsSource, /battle-data-dialog\.js\?v=20260811-ios-map-export/);
  assert.match(uiSource, /worldSelector\.js\?v=20260811-ios-map-export/);
  assert.match(uiSource, /guildNameEditor\.js\?v=20260811-ios-map-export/);
  assert.match(uiSource, /occupationTabs\.js\?v=20260811-ios-map-export/);
  assert.match(uiSource, /battle-data-dialog\.js\?v=20260811-ios-map-export/);
  assert.match(uiSource, /map-export\.js\?v=20260811-ios-map-export/);
