...
export function initializeElements() {
  ...
  elements.battleClassTabs = document.getElementById("battle-class-tabs");
  elements.battleBlockGrid = document.getElementById("battle-block-grid");
  elements.battleSelectionSummary = document.getElementById("battle-selection-summary");
