...
export const MAP_LAYOUT_CSS_VARS = {
  desktop: {
    ...
    "--map-shield-left": "82%",
    "--map-shield-top": "calc(50% + 16px)",
    "--map-shield-size": "87px",
    "--map-sword-left": "18%",
    "--map-sword-top": "calc(50% - 10px)",
    "--map-sword-size": "18px",
    "--map-point-labels-left": "50%",
    "--map-point-labels-top": "50%",
    "--map-point-labels-width": "49%",
    "--map-point-labels-gap": "2px",
    "--map-point-band-width": "125%",
    "--map-point-band-height": "18px",
    ...
    "--map-point-select-font-size": "0.55rem",
