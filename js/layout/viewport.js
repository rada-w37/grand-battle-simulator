...
export const MAP_LAYOUT_CSS_VARS = {
  desktop: {
    ...
    "--map-sword-size": "26px",
    // Point guild rows: labels-height = row-height * 2 + row-gap.
    // Band and select heights intentionally share the same row height.
    "--map-point-labels-left": "66px",
    "--map-point-labels-top": "21px",
    "--map-point-labels-width": "100px",
    "--map-point-row-height": "24px",
    "--map-point-row-gap": "4px",
    ...
    "--map-point-select-height": "24px",
    "--map-point-select-left": "0px",
    "--map-point-select-top": "0px",
    "--map-point-select-width": "100px",
    "--map-point-select-min-height": "24px",
    "--map-point-select-line-height": "24px",
  ...
  mobile: {
    ...
    "--map-sword-top": "8.46px",
    "--map-sword-size": "26px",
    // Keep the same row vocabulary on mobile, while preserving the current
    // mobile select touch sizing in CSS.
    "--map-point-labels-left": "66px",
    "--map-point-labels-top": "6.8px",
    "--map-point-labels-width": "57.2px",
    "--map-point-row-height": "11px",
    "--map-point-row-gap": "1px",
