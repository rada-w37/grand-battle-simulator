...
import { updateWorldOptions } from "./worldSelector.js?v=20260811-aura-composite";
import { getEditableGuildNames, updateGuildNameEditControls } from "./guildNameEditor.js?v=20260811-aura-composite";
...
import { renderOccupationTabs, resetOccupationTabs } from "./occupationTabs.js?v=20260811-aura-composite";
...
import { showBattleDataConfirmation, showDestructiveConfirmation } from "./presentation/battle-data-dialog.js?v=20260811-aura-composite";
import {
  canSharePngFile,
  captureMapPng,
  ...
  downloadPngFile,
  sharePngFile
} from "./presentation/map-export.js?v=20260811-aura-composite";
